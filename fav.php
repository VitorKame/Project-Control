            ...
            <div id="content-wrapper" class="d-flex flex-column bg-gray-900">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid ">
                        <div class="row">
                            <!-- Page Heading -->
                            <h1 class="h3 mb-4 text-gray-100 px-3">Acesso Rápido  </h1>
                            <a href="#"><i class="fas fa-exclamation-triangle text-warning" data-toggle="modal" data-target="#modalInicial"></i></a>
                        </div>
                        ...
                        <div class="row">
                                ...
                                <div class="card border-left-primary shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"><a href="#" data-toggle="modal" data-target="#modalTextLink">Adicionar</a></div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><a href="#" class="text-gray-800" data-toggle="modal" data-target="#modalTextLinkII">Cliente</a></div>
                                            </div>
                                            <div class="col-auto">
                                                <a href="#"><i class="fas fa-user-plus fa-2x text-gray-300" data-toggle="modal" data-target="#modalIcon"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!-- Earnings (Monthly) Card Example -->
                            <div class="col-xl-3 col-md-6 mb-4">
                                <a href="#" data-toggle="modal" data-target="#modalCard">
                                    <div class="card border-left-info shadow h-100 py-2">
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Atendidos Hoje</div>
                                                    <div class="row no-gutters align-items-center">
                                                        <div class="col-auto">
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card border-left-success shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Pendentes</div>
                        ...
                        <div class="row align-items-baseline">
                            ...
                            <div class="col-xl-8 col-lg-7">
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">Calendário <a href="#"><i class="fas fa-exclamation-triangle text-warning" data-toggle="modal" data-target="#modalCalendario"></i></a></h6>
                                        <div class="col-auto">
                            ...
                            <div class="col-xl-4 col-lg-5">
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="mw-100 card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold text-primary">Abrir PDV <a href="#"><i class="fas fa-exclamation-triangle text-warning" data-toggle="modal" data-target="#modalPDV"></i></a></h6>
                                    ...
                                    <div class="card-body justify-content-center mx-auto">
                                        <div class="col align-items-center">
                                            <div class="row">
                                                <div class="mx-auto">
                                                    <a href="caixa.html"><i class="fas fa-cash-register fa-10x text-gray-400"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="modal fade" id="modalCalendario" tabindex="-1" role="dialog" aria-labelledby="TituloModalCentralizado" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="TituloModalCentralizado">Informações sobre o calendário</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    Esse calendário vai funcionar como sua agenda, aqui você vai marcar seus compromissos.
                                </div>
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="modalInicial" tabindex="-1" role="dialog" aria-labelledby="TituloModalLongoExemplo" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="TituloModalLongoExemplo">BEM VINDA(O)!</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    Essa é a primeira tela após o acesso!<br>
                                    A sua esquerda existe uma barra lateral, ela vai funcionar como o menu principal do sistema.<br>
                                    Essa é a Pagina de acesso rápido, os cards abaixo vão servir como exemplo do que pode ser feito, é so clicar neles.
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
                                </div>
                    ...
                    <div class="modal fade" id="modalPDV" tabindex="-1" role="dialog" aria-labelledby="TituloModalCentralizado" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="TituloModalCentralizado">Informações sobre o PDV</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    PDV é Ponto De Venda, ao clicar você será redirecionado ao caixa, ele está preenchido com um exemplo de venda e explicações das funcionalidades que estarão presentes.
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
                                </div>
                    ...
                    <div class="modal fade" id="modalTextLink" tabindex="-1" role="dialog" aria-labelledby="TituloModalCentralizado" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="TituloModalCentralizado">Link em Texto dentro do card</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                    ...
                    <div class="modal fade" id="modalTextLinkII" tabindex="-1" role="dialog" aria-labelledby="TituloModalCentralizado" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="TituloModalCentralizado">Link em Texto dentro do card</h5>
                    ...
                    <div class="modal fade" id="modalIcon" tabindex="-1" role="dialog" aria-labelledby="TituloModalCentralizado" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="TituloModalCentralizado">Link em Icone dentro do card</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    Este icone é um link
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
                                </div>
                    ...
                    <div class="modal fade" id="modalCard" tabindex="-1" role="dialog" aria-labelledby="TituloModalCentralizado" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="TituloModalCentralizado">Link em forma de card</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    Este card todo é um link
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
                                </div>
                    ...
                    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">Selecione "Logout" se você está pronto pra deixar a sessão.</div>
                                <div class="modal-footer">
